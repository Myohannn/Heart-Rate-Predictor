...
class DataMerge:
    def __init__(self):
        # ID7 Treadmill
        # ECG_time_up = '2021-04-16 11:47:00'
        # ECG_time_down = '2021-04-16 11:53:00'
        # PPG_time_up = '11:47:00'
        # PPG_time_down = '11:53:00'
        self.df1 = None
        self.df2 = None
        self.df_merge = None
    ...
    def separate_data(self,output_filename):
        df1 = self.df_merge.loc[(self.df_merge['record.heart_rate[bpm]'] <= conf.get("Data_Merge", "HR_low"))]
        df2 = self.df_merge.loc[
            (self.df_merge['record.heart_rate[bpm]'] > conf.get("Data_Merge", "HR_low")) & (self.df_merge['record.heart_rate[bpm]'] <= conf.get("Data_Merge", "HR_high"))]
        df3 = self.df_merge.loc[(self.df_merge['record.heart_rate[bpm]'] > conf.get("Data_Merge", "HR_high"))]
    ...
    def run(self):
        ...
        self.df_merge.to_excel("dataset/training_data/merged_data/" + output_filename, index=False)
